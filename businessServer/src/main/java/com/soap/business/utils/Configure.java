package com.soap.business.utils;
...
public class Configure {
    ...
    public Configure() {
        ...
        this.esHost = ConfigurationManager.config().getString(Constants.ES_TRANSPORTHOSTS()).split(":")[0];
        this.esPort = Integer.parseInt(ConfigurationManager.config().getString(Constants.ES_TRANSPORTHOSTS()).split(":")[1]);
